  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/outletters">Surat Keluar</a></li>
          ...
          <div class="card-body mt-3">
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                @endif
                <!-- Vertical Form -->
                <form class="row g-3" action="/outletters/{{ $outletter->random_id }}" method="post">
                  @csrf
                  @method('put')
                  <div class="col-12">
                  ...
                  <div>
                    ...
                    <a href="/outletters" class="btn btn-warning"><i class="bx bx-left-arrow"></i> Kembali</a>
                  </div>
                </form><!-- Vertical Form -->
              </div>
            </div>
