...
class InletterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('inletters')->with('success', 'Data berhasil ditambah.');
    }
    ...
    public function update(Request $request, Inletter $inletter)
    {
        ...
        return redirect('inletters')->with('success', 'Data berhasil diubah.');
    }
    ...
    public function destroy(Inletter $inletter)
    {
        ...
        return redirect('inletters')->with('success', 'Data berhasil dihapus');
    }
}